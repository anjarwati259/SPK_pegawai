	          ...
	          <tbody>
	            ...
	            <tr>
	            	...
	            	<td>
		                ...
		                <!-- hapus -->
		                <a href="<?php echo base_url('admin/del_kriteria/'.$value->id_kriteria) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini? Dengan menghapus data ini, data anda yang berkaitan dengan data ini juga akan ikut terhapus.')"><i class="fa fa-trash" aria-hidden="true"></i></a>
	            	</td>
	            </tr>
	        	<?php } ?>
	          </tbody>
