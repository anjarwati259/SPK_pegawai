	          ...
	          <tbody>
	            ...
	            <tr>
	            	...
	            	<td>
		                ...
		                <!-- hapus -->
		                <a href="<?php echo base_url('admin/del_bobot/'.$value->id_bobot) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
	            	</td>
	            </tr>
	        	<?php } ?>
	          </tbody>
